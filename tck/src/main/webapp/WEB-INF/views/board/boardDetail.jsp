...
<div class="container" id="container">
	...
	<form name="frmSearch" method="post" action="<c:url value='/board/write.do'/>">
		...
		<div class=nav_div>
			<a href="<c:url value='/board/replyWrite.do?boardSeq=${boardVo.boardSeq }'/>" class="tag_a_reply">	
					<div class="btn_reply">
						댓글
					</div>
			</a>
		...
		<div class=nav_div>
			<a href="<c:url value='/boardList.do'/>" class="tag_a">	
				...
				<c:if test="${myIp eq 999 }">	
					<div>
						<button class="btn btn-primary_write" 
    					 onclick="location.href = '<c:url value="/board/edit.do?boardSeq=${boardVo.boardSeq }"/>'">수정</button>
					</div>
				</c:if>	
