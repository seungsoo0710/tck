...
<div class="container" id="container">
	...
	<form name="frmEdit" method="post" action="<c:url value='/board/edit.do'/>">
		...
		<div class="write_menu1">
			...
			<input type="hidden" id="input_4" class="form-control" name="refMemberseq" value="${boardVo.writer }">
			<input type="hidden" id="input_6" class="form-control" name="boardSeq" value="${boardVo.boardSeq }">
			<input type="hidden" id="input_7" class="form-control" name="boardTitle" value="${boardVo.title }">
